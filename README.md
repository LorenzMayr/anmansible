# Automatic Network Configuration with Ansible

A collection of scripts and playbooks to be used for implementing a Netbox -> Ansible Connection for managing Aruba devices in your network.
